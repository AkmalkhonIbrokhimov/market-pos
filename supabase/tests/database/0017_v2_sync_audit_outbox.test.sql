...
with errors(sig,code)as(values
 ('public.v2_guard_sync_command()','V2_SYNC_DEPENDENCIES_INVALID'),('public.v2_guard_sync_command()','V2_SYNC_RESOLUTION_SOURCE_INVALID'),('public.v2_guard_sync_command()','V2_SYNC_ENVELOPE_IMMUTABLE'),('public.v2_guard_sync_command()','V2_SYNC_TERMINAL_IMMUTABLE'),('public.v2_guard_sync_command()','V2_SYNC_STATUS_TRANSITION_INVALID'),
...
insert into organizations(id,name)values('00000000-0000-0000-0000-000000017101','Org17');
...
insert into branches(id,organization_id,code,name)values('00000000-0000-0000-0000-000000017401','00000000-0000-0000-0000-000000017101','B17','Branch17');
...
set local role authenticated;
select is(v2_submit_sync_command('00000000-0000-0000-0000-000000017101','00000000-0000-0000-0000-000000017701','00000000-0000-0000-0000-000000017818','shift.close',1,jsonb_build_object('shift_id',(select id from shifts_v2 where register_id='00000000-0000-0000-0000-000000017601'),'actual_totals',jsonb_build_object('cash',136,'card',0,'transfer',0),'cash_counts',jsonb_build_array(jsonb_build_object('line_number',1,'denomination_value',136,'quantity',1))),now())->>'status','accepted','offline shift close accepted and excludes own sync row');
reset role;
...
select ok(position(code in pg_get_functiondef('public.v2_event_reconciliation(uuid)'::regprocedure))>0,'reconciliation detects '||code)from(values
